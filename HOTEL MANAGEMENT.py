...
def date(c):
  if c[2] >= 2020 and c[2] <= 2021:
    if c[1] != 0 and c[1] <= 12:
      ...
      elif c[1] <= 7 and c[1]%2 == 0 and c[0] <= 30
          and c[1] != 2:
          pass
...
def Booking():
  ...
  while 1:
    ...
    if n!="" and p1!="" and a!="":
      ...
      d = (d2-d1).days
      day.append(d)
      print("----WHAT TYPE OF ROOMS DO YOU PREFER?!----")
      print(" 1. Deluxe Non-AC")
      print(" 2. Deluxe AC")
      print(" 3. Double cot Non-AC")
      print(" 4. Double cot AC")
      ...
      # type and it's price
      if ch==0:
        print(" 1. Deluxe Non-AC - Rs. 3500")
        print(" 2. Deluxe AC - Rs. 4000")
        print(" 3. Double cot Non-AC - Rs. 5500")
        print(" 4. Double cot AC- Rs. 6000")
        ch=int(input("->"))
      if ch==1:
        room.append('Deluxe Non-AC')
        print("Room Type- Deluxe Non-AC")
        price.append(3500)
        print("Price- 3500")
      elif ch==2:
        room.append('Deluxe AC')
        print("Room Type- Deluxe AC")
        price.append(4000)
        print("Price- 4000")
      elif ch==3:
        room.append('Double cot Non-AC')
        print("Room Type- Double cot Non-AC")
        price.append(4500)
        print("Price- 5500")
      elif ch==4:
        room.append('Double cot AC')
        print("Room Type- Double cot AC")
        price.append(5000)
        print("Price- 6000")
      else:
        print(" Wrong choice..!!")
...
def Rooms_Info():
  ...
  print("DELUXE NON-AC")
  print("---------------------------------------------------------------")
  print("Room facilities include: Single Bed, Television,Landline,")
  print("Triple-shuttered Cupboard, 1 Dining table with 1 Triple seater sofa, Balcony and")
  print("an attached bathroom with Water Heater(both cold and hot).\n")
  print("DELUXE AC")
  print("---------------------------------------------------------------")
  print("Room facilities include: Single Bed, Television,Landline,")
  print("Triple shuttered Cupboard, 1 Dining table with 1 Triple seater sofa, Balcony and")
  print("an attached bathroom with Water Heater(both cold and hot) + Window/Split AC.\n")
  print("DOUBLE COT NON-AC")
  print("---------------------------------------------------------------")
  print("Room facilities include: 1 Double Bed ,Television,")
  print("Telephone, a Four shuttered Cupboard, 1 Dining table with 2 Triple seater sofa, ")
  print("1 Side table, Balcony with an Accent table with
3 Chairs and an")
  print("attached bathroom with Water Heater(both cold
and hot).\n")
  print("DOUBLE COT AC")
  print("---------------------------------------------------------------")
  print("Room facilities include: 1 Double Bed ,Television,")
  print("Telephone, a Four shuttered Cupboard, 1 Dining table with 2 Triple seater sofa, ")
  print("1 Side table, Balcony with an Accent table with 3 Chairs and an")
  print("attached bathroom with Water Heater(both cold and hot) + Window/Split AC.\n\n")
  print()
  n=int(input("0-BACK\n ->"))
  if n==0:
    Home()
...
def restaurant():
  ...
  for n in range(0,i):
    ...
    print(" 20 Chilli Paneer.......... 140.00 ICECREAM")
